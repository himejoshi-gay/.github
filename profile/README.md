...
**[Himejoshi](https://himejoshi.gay/)** is an enhanced distribution and fork of the [Sunrise](https://github.com/SunriseCommunity/Sunrise) osu! private server framework. Our goal is to extend the core Sunrise ecosystem, adding exclusive new features and refining the player experience for a more polished community environment.

## Preview 🖼️

![preview](https://raw.githubusercontent.com/himejoshi-gay/Apollo/main/.github/preview.png)
...
All Himejoshi components are licensed under the **MIT license**. You can read the full text [here](./LICENSE).